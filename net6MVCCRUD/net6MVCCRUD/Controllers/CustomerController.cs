...
using EFCoreConsoleAppla.Models;
...
namespace net6MVCCRUD.Controllers
{
    ...
    {
        private readonly AdsPumaDbContext _context;

        public CustomerController(AdsPumaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Customer != null ? 
                          ...
                          Problem("Entity set 'AdsPumaDbContext.Customer'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdsPumaDbContext.Customer'  is null.");
            }
            var customer = await _context.Customer.FindAsync(id);
            if (customer != null)
            {
